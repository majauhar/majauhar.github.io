...
feature: 1
---
Simulating the United Nations (UN) session is an important activity in diplomacy training at high-school and university levels. While in real-world simulations, student play the roles of various stakeholders. However, could we simulate such activity using multiple agents instead? In this post, I am going to try the CAMEL-AI multi-agent framework to do just that.
